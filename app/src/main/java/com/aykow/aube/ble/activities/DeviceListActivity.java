...
public class DeviceListActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setListener(new DeviceListAdapter.OnAddButtonClickListener() {
            @Override
            public void onAddButtonClick(int position) {
                ...
                BluetoothDevice selected_aube= mDeviceList.get(position);
                Intent addIntent = new Intent(DeviceListActivity.this, RecordAubeActivity.class);
                addIntent.putExtra("selected_aube", selected_aube);
                startActivity(addIntent);
            }

           /* ancien public void onPairButtonClick(int position) {
